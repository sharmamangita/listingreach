...
class ProfilelogoModal extends React.Component {
    constructor(props, context) {
        ...
        user:  Object.assign({
          ...
          restoreFocus:true,
          submitted: false,
          proimg:'/public/assets/images/dummy-logo.png' 
        };
    ...
    render() {
		...
		if(profileuser.profilePic){
			var url=`${config.uploadapiUrl}/uploads/${profileuser.profilePic}`;
		} 
			...
			return (
             ...
             <div className="row form-group">
                <div className="col-md-12 col-lg-12 mb-3 mb-md-0">
                    <label className="font-weight-bold" htmlFor="fullname">Upload Logo Image*</label>
